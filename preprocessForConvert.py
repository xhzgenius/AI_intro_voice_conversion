...
if __name__ == '__main__':
    ...
    origin_wavpath_default = "./convertFolder/wav" #
    # 降采样生成的16kwav的目录：
    # target_wavpath_default = "./data/VCTK-Corpus/wav16"
    target_wavpath_default = "./convertFolder/wav16" #
    # 处理完成的numpy一维数组的目录：（分别是训练集和测试集）
    mc_dir_train_default = './convertFolder/data'
    mc_dir_test_default = './convertFolder/data'
    i_vector_dir_default = "./convertFolder/data/i_vector"
    # #############################################################################################
