...
speakers = os.listdir("/processed_data/source/wav16")
...
class MyDataset(data.Dataset):
    ...
    def __init__(self, data_dir):
        ...
        # mc_files = [i for i in mc_files if basename(i).split(".")[0] in speakers] #
...
class TestDataset(object):
    ...
    def __init__(self, data_dir, wav_dir, src_spk='p262', trg_spk='p272'):
        ...
        # self.mc_files = sorted(glob.glob(join(data_dir, '*.npy'))) #
